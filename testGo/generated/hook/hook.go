...
// The PetsFunc type is an adapter to allow the use of ordinary
// function as Pets mutator.
type PetsFunc func(context.Context, *generated.PetsMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PetsFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PetsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.PetsMutation", m)
}

// The UsersFunc type is an adapter to allow the use of ordinary
// function as Users mutator.
type UsersFunc func(context.Context, *generated.UsersMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UsersFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UsersMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UsersMutation", m)
}
